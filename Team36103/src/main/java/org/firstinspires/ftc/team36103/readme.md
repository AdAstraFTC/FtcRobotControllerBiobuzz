# Team36103 OpMode Guide

Welcome to your team's code module!

This is where **your** robot code lives. Everything you write or copy should stay inside this `Team36103` folder. The `FtcRobotController` module (the official FTC samples) should **never** be edited — it gets replaced when the FTC SDK updates.
...
4. Expand your module: `Team36103 > java > org.firstinspires.ftc.teamcode`
...
- Your code belongs only in the `Team36103` module. Never edit anything inside `FtcRobotController`.
