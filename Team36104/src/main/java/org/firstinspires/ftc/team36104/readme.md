# Team36104 OpMode Guide

Welcome to your team's code module!

This is where **your** robot code lives. Everything you write or copy should stay inside this `Team36104` folder. The `FtcRobotController` module (the official FTC samples) should **never** be edited — it gets replaced when the FTC SDK updates.
...
- Your code belongs only in the `Team36104` module. Never edit anything inside `FtcRobotController`.
